...
const VERSION_HISTORY = [
    { version: 'v1.80', date: '2026-06-02', description: 'Clickable Clover item ID in the edit panel; dated changelog entries' },
    { version: 'v1.79', date: '2026-05-31', description: 'Handle empty (no-delivery) worksheets instead of erroring' },
    { version: 'v1.78', date: '2026-05-29', description: 'Floor pull capped at bin size and expected quantity' },
    { version: 'v1.77', date: '2026-05-25', description: 'Combined CSV: auto-import newest worksheet on visit, bulk-receive prompt, /csv-current for the produce processor' },
    { version: 'v1.76', date: '2026-05-19', description: 'Skip non-worksheet CSVs when categorizing import files' },
    { version: 'v1.75', date: '2026-05-06', description: 'Route /ingest to incoming-v2/; stamp Firebase download tokens on uploads' },
    { version: 'v1.74', date: '2026-05-01', description: 'Replace supplier Accept header with a receive-all toggle pill' },
    { version: 'v1.73', date: '2026-04-28', description: 'Add /ingest endpoint for the IT-supplied combined CSV' },
    { version: 'v1.72', date: '2026-04-26', description: 'Fetch Daily Files: per-file date pickers in a modal' },
    { version: 'v1.71', date: '2026-04-25', description: 'Deep-link to a single supplier via URL hash' },
    { version: 'v1.70', date: '2026-04-23', description: 'Import page and Locations sort: surface inventory, rename buckets' },
    { version: 'v1.69', date: '2026-04-21', description: 'Date dropdown contrast fix; PDF parser recovers glued floor-pull lines' },
    { version: 'v1.68', date: '2026-04-17', description: 'Show first and most-recent check-in times under the summary numbers' },
    { version: 'v1.67', date: '2026-04-16', description: 'PDF parser allows digits in supplier names; Fetch Daily Files authenticates to the coop intranet' },
    { version: 'v1.66', date: '2026-04-15', description: 'Edit panel: note textarea beside item name, out-of-stock red “None” toggle; fix completed-badge overlap' },
    { version: 'v1.65', date: '2026-04-14', description: 'Multi-supplier rows: collapse with a “multi” pill, per-supplier expand, daily totals, pull circles, legend; recent-searches dropdown; item and supplier title in edit modal' },
    { version: 'v1.64', date: '2026-04-13', description: 'Overlay edit modal: sticky-note positioning, integrated notes, no separate pull popup' },
    { version: 'v1.63', date: '2026-04-12', description: '7-day delivery history: date dropdown, read-only past days, auto-cleanup; Notes & Changes filter; double-click Accept to bulk accept/unaccept' },
    { version: 'v1.62', date: '2026-04-11', description: 'Add Pulls Only filter; rename “Show Expected Only” to “Hide Received”' },
    { version: 'v1.61', date: '2026-04-10', description: 'Merge street view into the single delivery view; header cleanup and z-index fix; restyle note popup; Accept-all out-of-stock fixes' },
    { version: 'v1.60', date: '2026-04-06', description: '“NOT TODAY’S DATA” banner for past deliveries; Clover link in the menu; disable iPad pinch and double-tap zoom' },
    { version: 'v1.59', date: '2026-03-30', description: 'Street view: edit-panel cancel button, bigger supplier names' },
    { version: 'v1.58', date: '2026-03-27', description: 'Daily log system: shared daily snapshots with history view and cross-day item search; standalone printable daily report; collapsible combined report' },
    { version: 'v1.57', date: '2026-03-26', description: 'Street view inline edit panel with pull stepper and out-of-stock toggle; clear pull quantity when marking out of stock' },
    { version: 'v1.56', date: '2026-03-25', description: 'Default to show-received view; keep out-of-stock items visible under Hide Received; edit-panel fixes; peeling-sticker link icon' },
    { version: 'v1.55', date: '2026-03-24', description: 'Redesign inline edit panel with a horizontal layout; out-of-stock group with strikethrough and /oos-items API; Produce Processor nav link' },
    { version: 'v1.54', date: '2026-03-23', description: 'Add inline edit panel with item notes and a quantity-receive circle; sticky sort and search bar' },
    { version: 'v1.53', date: '2026-03-22', description: 'Street view pull workflow: pulled-count per supplier, collapse, sticky change-alert banner; quick-receive target circles; header shows view name first' },
    { version: 'v1.52', date: '2026-03-13', description: 'Pull UX: change alerts, street view toggle, popup improvements, Julian-day DST fix' },
    { version: 'v1.51', date: '2026-03-12', description: 'Clover file upload with status panel and help screenshots; Show/Hide Received toggle; import screen redesign' },
    { version: 'v1.50', date: '2026-03-10', description: 'PDF parser improvements; supplier-chip header layout' },
    { version: 'v1.49', date: '2026-03-03', description: 'Fix PDF parsing edge cases; remove quick-receive target circles' },
    { version: 'v1.48', date: '2026-03-01', description: 'Header color follows the delivery date, not today' },
    { version: 'v1.47', date: '2026-02-27', description: 'Header week color and Julian day/week; street-view icon; blue supplier sub-row chips; UI polish' },
    { version: 'v1.46', date: '2026-02-26', description: 'Live-update street view when changes arrive from other devices' },
    { version: 'v1.45', date: '2026-02-25', description: 'Storage file picker shows the delivery date instead of the full filename' },
    { version: 'v1.44', date: '2026-02-24', description: 'Street view pulls show pull quantity as “X (of N)” with the supplier total' },
